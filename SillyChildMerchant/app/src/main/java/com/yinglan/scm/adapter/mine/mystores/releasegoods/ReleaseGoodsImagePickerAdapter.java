...
public class ReleaseGoodsImagePickerAdapter extends RecyclerView.Adapter<ReleaseGoodsImagePickerAdapter.SelectedPicViewHolder> {
    ...
    public ReleaseGoodsImagePickerAdapter(Context mContext, List<ImageItem> data, int maxImgCount, int initpicres) {
    ...
    public SelectedPicViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SelectedPicViewHolder(mInflater.inflate(R.layout.item_productimg, parent, false));
    }
