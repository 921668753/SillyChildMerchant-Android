...
import com.yinglan.scm.message.interactivemessage.rongcloud.db.BlackListDao;
import com.yinglan.scm.message.interactivemessage.rongcloud.db.DBManager;
import com.yinglan.scm.message.interactivemessage.rongcloud.db.Friend;
import com.yinglan.scm.message.interactivemessage.rongcloud.db.FriendDao;
import com.yinglan.scm.message.interactivemessage.rongcloud.db.GroupMember;
import com.yinglan.scm.message.interactivemessage.rongcloud.db.GroupMemberDao;
import com.yinglan.scm.message.interactivemessage.rongcloud.db.Groups;
import com.yinglan.scm.message.interactivemessage.rongcloud.db.GroupsDao;
import com.yinglan.scm.message.interactivemessage.rongcloud.db.UserInfoBean;
import com.yinglan.scm.message.interactivemessage.rongcloud.model.GroupInfoEngine;
import com.yinglan.scm.message.interactivemessage.rongcloud.network.async.AsyncTaskManager;
import com.yinglan.scm.message.interactivemessage.rongcloud.network.async.OnDataListener;
import com.yinglan.scm.message.interactivemessage.rongcloud.network.http.HttpException;
import com.yinglan.scm.message.interactivemessage.rongcloud.pingyin.CharacterParser;
import com.yinglan.scm.message.interactivemessage.rongcloud.response.GetBlackListResponse;
import com.yinglan.scm.message.interactivemessage.rongcloud.response.GetGroupInfoResponse;
import com.yinglan.scm.message.interactivemessage.rongcloud.response.GetGroupMemberResponse;
import com.yinglan.scm.message.interactivemessage.rongcloud.response.GetGroupResponse;
import com.yinglan.scm.message.interactivemessage.rongcloud.response.GetTokenResponse;
import com.yinglan.scm.message.interactivemessage.rongcloud.response.UserRelationshipResponse;
